...
| `connectionTimeout` | `20000` | Milliseconds to wait for the client to send the request URI line after the TCP connection is accepted. |
...
| `connectionTimeout` | `60000` | Milliseconds to wait for an AJP packet from the front-end server. |
